...
from nonebot.adapters.onebot.v12 import Bot, Message, GroupMemberIncreaseEvent # type: ignore
from nonebot import on_notice

NewWelcome = on_notice()

@NewWelcome.handle()
async def welcoming (bot: Bot, event: GroupMemberIncreaseEvent, state: T_State):
